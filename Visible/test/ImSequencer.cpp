        ...
        else
        {
            ...
            */
            ...
            auto drawLine = [&](int i, int regionHeight) {
                ...
                int tiretStart = baseIndex ? 4 : (halfIndex ? 10 : scrollBarHeight);
            ...
            if (hasScrollBar)
            {
             ...
             //   float handleRadius = (scrollBarMax.y - scrollBarMin.y) / 2;
                draw_list->AddRectFilled(scrollBarC, ImVec2(scrollBarC.x + scrollBarHeight, scrollBarD.y), 0xFFAAAAAA, 6);
                draw_list->AddRectFilled(ImVec2(scrollBarD.x - scrollBarHeight, scrollBarC.y), scrollBarD, 0xFFAAAAAA, 6);
