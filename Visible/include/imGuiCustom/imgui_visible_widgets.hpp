//
//  imgui_visible_widgets.hpp
//  Visible
//
//  Created by Arman Garakani on 9/1/19.
//

#ifndef imgui_visible_widgets_hpp
...
namespace ImGui {
    ...
    // Use this structure to pass the contraction data and settings into the Plot function
    struct ContractionPlotConfig {
        struct Values {
    ...
    IMGUI_API Status Plot(const char* label, const ContractionPlotConfig& conf);
    };

#endif /* imgui_visible_widgets_hpp */
