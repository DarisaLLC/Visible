...
public:
     ...
     *
     */
    self_similarity_producer(uint32_t matrixSz, uint32_t cacheSz, const progress_fn_t& pf = nullptr,
...
private:
    ...
    const double                       _tiny;
    double                             _log2MSz;
    float                              _single_weight;
    float                              _fraction_done;
