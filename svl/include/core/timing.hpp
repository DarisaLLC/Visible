...
{
public:
    clock(const std::string& name) : m_start_time(0), m_count(0), m_sofar(0)
    {
    ...
    {
        return clock::getTime() / 1000000.0;
    }
...
std::ostream& operator<<(std::ostream& out, clock& timer)
{
...
inline bool operator<(const clock& x, const clock& y)
{
