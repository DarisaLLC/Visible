...
//  
//
//  Created by Arman Garakani on 5/15/19.
//
...
float angleBetweenTwoPoints(const vec2& pt1, const vec2& pt2, bool radian){
    double x1 = pt1.x;
    double y1 = pt1.y;
    double x2 = pt2.x;
    double y2 = pt2.y;
    ...
    if(radian) return angle_rads;
    return toDegrees(angle_rads);
}
