...
@implementation cpVisionUtilities
...
+ (CGPoint)convertToPointOfInterestFromViewCoordinates:(CGPoint)viewCoordinates inFrame:(CGRect)frame
{
    ...
    switch ([[cpVision sharedInstance] previewOrientation]) {
...
//        viewCoordinates.x = frameSize.width - viewCoordinates.x;
    ...
    AVCaptureVideoPreviewLayer *previewLayer = [[cpVision sharedInstance] previewLayer];
...
@implementation NSString (cpExtras)
