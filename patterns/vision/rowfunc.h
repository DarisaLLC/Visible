...
public:
    ...
    inline double compute()
    {
        ...
        mRp = (mEi == 0 || mEi == 0) && (mSmm == mSii) && (mSi == mSm);

        mCosine = ((mN * mSim) - (mSi * mSm));
        mCosine = mCosine < 0 ? 0 : mCosine;
        double ti = static_cast<double>(mCosine);
        double tm = ti / static_cast<double>(mEi);
        mR = ti / static_cast<double>(mEm);
        mR *= tm;
        return mR;
    }
    ...
    {
        return acos(static_cast<double>(mCosine) / sqrt(static_cast<double>(mEi) * static_cast<double>(mEm)));
    }
